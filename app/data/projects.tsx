...
const projects: Project[] = [
  {
    projectName: "ORMA",
    imgUrl:
      "https://res.cloudinary.com/daiio9iqt/image/upload/v1733743944/projects/4daed393-f61d-4c6b-bc92-0c0a64acb786.png",
    desc: "Create actionable business recommendations from user feedback with ai.",
    gitLink: "#",
    link: "#",
    tools: ["Nextjs", "Postgresql", "Drizzle", "Gemini-API", "TailwindCSS"],
    status: "In-progress",
  },
  {
    projectName: "Draft",
    ...
    gitLink: "https://draft-beta-pink.vercel.app/signup",
    link: "https://draft-beta-pink.vercel.app/signup",
  ...
  },
  {
    ...
    imgUrl:
      "https://res.cloudinary.com/daiio9iqt/image/upload/v1725383862/projects/f43c749a-ff14-49f4-855f-5d7426a0feae.png",
